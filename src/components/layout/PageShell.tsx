...
export function PageShell({ children }: PageShellProps) {
  return (
    <main className="relative isolate min-h-screen overflow-hidden bg-black text-neutral-100">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 opacity-30 [background-image:linear-gradient(115deg,transparent_0_17%,rgba(0,0,0,0.96)_17%_25%,transparent_25%_42%,rgba(0,0,0,0.92)_42%_52%,transparent_52%_100%)]" />
